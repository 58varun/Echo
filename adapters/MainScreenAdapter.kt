package com.example.varundatta.echo.adapters
...
import com.example.varundatta.echo.Songs
import com.example.varundatta.echo.R

class MainScreenAdapter(_songDetails: ArrayList<Songs>,
                        _context: Context) : RecyclerView.Adapter<MainScreenAdapter.MyViewHolder>() {
